...
public interface IEspStatusPlugs extends IEspDeviceStatus {
	...
	public interface IAperture {
		/**
		 * the id is according to the order of the aperture, they are 0,1,2,3...
		 * 
	...
	/**
	 * update the aperture thoroughly if the aperture exist, add a new aperture
	 * if the aperture doesn't exist
	 * 
	 * @param newAperture
	 *            the aperture to be updated or added
	 */
	public void updateOrAddAperture(IAperture newAperture);

	/**
	 * update the specific aperture's isOn state( it will only update the
	 * specific apertures's isOn state)
	 * 
	 * @param newAperture
	 *            the aperture to be updated
	 * @return whether the aperture is exist( it will update the specific
	 *         aperture's isOn state , it the newAperture's id dones't exist in
	 *         IEspStatusPlugs, it will return false)
	 */
