...
public interface IDeviceDB extends IEspDBObject {
	 ...
	 * 
	 * @param isOwner
	 *            whether the user is the device's owner
	 */
	 ...
	 * 
	 * @param rom_version
	 *            the current rom version of the device
	 */
	 ...
	 *            the latest rom version of the device
	 */
	 ...
	 * 
	 * @param timestamp
	 *            the timestamp of the device when the device is configured by
	 *            user
	 */
	 ...
	 * 
	 * @param userId
	 *            the user's id who has the authority to use the device
	 */
