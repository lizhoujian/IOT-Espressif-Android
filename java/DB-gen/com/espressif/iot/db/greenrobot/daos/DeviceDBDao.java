...
public class DeviceDBDao extends AbstractDao<DeviceDB, Long> {
	...
	public static class Properties {
		...
		public final static Property Bssid = new Property(2, String.class,
				"bssid", false, "BSSID");

		public final static Property Type = new Property(3, int.class, "type",
				false, "TYPE");

		public final static Property State = new Property(4, int.class,
				"state", false, "STATE");

		public final static Property IsOwner = new Property(5, boolean.class,
				"isOwner", false, "IS_OWNER");

		public final static Property Name = new Property(6, String.class,
				"name", false, "NAME");

		public final static Property Rom_version = new Property(7,
				String.class, "rom_version", false, "ROM_VERSION");

		public final static Property Latest_rom_version = new Property(8,
				String.class, "latest_rom_version", false, "LATEST_ROM_VERSION");

		public final static Property Timestamp = new Property(9, long.class,
				"timestamp", false, "TIMESTAMP");

		public final static Property ActivatedTime = new Property(10,
				long.class, "activatedTime", false, "ACTIVATED_TIME");

		public final static Property UserId = new Property(11, long.class,
				"userId", false, "USER_ID");
		public final static Property ProductId = new Property(12, long.class,
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'DEVICE_DB' (" + //
				...
				"'PRODUCT_ID' INTEGER NOT NULL );"); // 12: productId
	}
	...
	protected void bindValues(SQLiteStatement stmt, DeviceDB entity) {
		...
		stmt.bindLong(13, entity.getProductId());
	}
    ...
    public DeviceDB readEntity(Cursor cursor, int offset)
    {
        DeviceDB entity = new DeviceDB( //
            ...
            cursor.getLong(offset + 12) // productId
            );
        return entity;
    }
	...
	public void readEntity(Cursor cursor, DeviceDB entity, int offset) {
		...
		entity.setRom_version(cursor.isNull(offset + 7) ? null : cursor
				.getString(offset + 7));
		entity.setLatest_rom_version(cursor.isNull(offset + 8) ? null : cursor
				.getString(offset + 8));
		...
		entity.setProductId(cursor.getLong(offset + 12));
	}
	...
	protected String getSelectDeep() {
		if (selectDeep == null) {
			...
			builder.append(',');
			SqlUtils.appendColumns(builder, "T0", daoSession.getUserDBDao()
					.getAllColumns());
	...
	protected DeviceDB loadCurrentDeep(Cursor cursor, boolean lock) {
		...
		UserDB userDB = loadCurrentOther(daoSession.getUserDBDao(), cursor,
				offset);
		if (userDB != null) {
